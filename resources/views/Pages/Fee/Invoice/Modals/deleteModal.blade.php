    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">{{ trans('invoice.deleteInvoice') }}</h1>
            ...
            <div class="modal-body">
                <form action="{{ route('invoice.destroy', 'test') }}" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-danger">{{ trans('invoice.deleteInvoice') }}</button>
                    </div>
                </form>
            </div>
        </div>
