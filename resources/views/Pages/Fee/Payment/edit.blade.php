    ...
    <div class="">
        <div class="">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <form class=" row  needs-validation" novalidate action="{{ route('payment.update', 'test') }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-floating mb-3 has-validation">
                                            <input type="number" class="form-control" id="validationCustom03"
                                                name="amount" min="1" value="{{ $payment->amount }}" required>
                                    ...
                                    <div class="col-12 has-validation">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" name="description">{{ $payment->description }}</textarea>
