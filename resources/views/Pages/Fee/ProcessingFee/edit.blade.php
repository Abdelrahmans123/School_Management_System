    ...
    <div class="">
        <div class="">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <form class=" row  needs-validation" novalidate action="{{ route('processing.update', 'test') }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-floating mb-3 has-validation">
                                            <input type="number" class="form-control" id="validationCustom03"
                                                name="amount" min="1" value="{{ $processing->amount }}" required>
                                    ...
                                    <div class="col-6 has-validation">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" name="description">{{ $processing->description }}</textarea>
