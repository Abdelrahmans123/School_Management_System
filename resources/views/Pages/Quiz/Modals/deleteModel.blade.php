    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">{{ trans('quiz.deleteQuiz') }}</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body">
                <form action="{{ route('teacher.quiz.destroy', 'test') }}" method="POST"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-danger">{{ trans('quiz.deleteQuiz') }}</button>
                    </div>
                </form>
            </div>
