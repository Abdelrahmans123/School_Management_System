    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">{{ trans('subject.deleteSubject') }}</h1>
            ...
            <div class="modal-body">
                <form action="{{ route('subject.destroy','test') }}" method="POST"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-danger">{{ trans('subject.deleteSubject') }}</button>
                    </div>
                </form>
            </div>
